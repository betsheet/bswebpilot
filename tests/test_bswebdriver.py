...
from bswebpilot.bsselenium.webdriver import BSWebDriverSync
...
class TestBSWebDriverNavigation:
    ...
    def test_navigate_to_changes_url(self, driver: BSWebDriverSync):
        """navigate_to() debe cambiar la URL actual a la destino."""
        driver.navigate_to(TEST_URL)
        assert TEST_URL in driver.get_current_url()

    def test_get_current_url_returns_string(self, driver: BSWebDriverSync):
    ...
    def test_wait_page_to_be_loaded_does_not_raise(self, driver: BSWebDriverSync):
    ...
    def test_navigate_multiple_times(self, driver: BSWebDriverSync):
        """Navegar varias veces seguidas no debe provocar errores."""
        for _ in range(3):
            driver.navigate_to(TEST_URL)
        assert TEST_URL in driver.get_current_url()

    def test_maximize_window_does_not_raise(self, driver: BSWebDriverSync):
...
class TestBSWebDriverElements:
    ...
    def test_is_element_clickable_true(self, driver: BSWebDriverSync):
    ...
    def test_find_element_returns_element(self, driver: BSWebDriverSync):
    ...
    def test_find_elements_returns_list(self, driver: BSWebDriverSync):
    ...
    def test_get_text_h1(self, driver: BSWebDriverSync):
    ...
    def test_get_text_xpath(self, driver: BSWebDriverSync):
    ...
    def test_get_class_returns_string(self, driver: BSWebDriverSync):
    ...
    def test_get_attribute_href_link(self, driver: BSWebDriverSync):
    ...
    def test_wait_element_to_be_present_does_not_raise(self, driver: BSWebDriverSync):
        """wait_element_to_be_present() no lanza excepción para un elemento existente."""
        driver.navigate_to(TEST_URL)
        driver.wait_element_to_be_present(LOC_H1)

    def test_wait_element_to_be_clickable_does_not_raise(self, driver: BSWebDriverSync):
        """wait_element_to_be_clickable() no lanza excepción para el enlace."""
        driver.navigate_to(TEST_URL)
        driver.wait_element_to_be_clickable(LOC_LINK)

    def test_wait_element_to_be_visible_does_not_raise(self, driver: BSWebDriverSync):
        """wait_element_to_be_visible() no lanza excepción para el <h1>."""
        driver.navigate_to(TEST_URL)
        driver.wait_element_to_be_visible(LOC_H1)

    def test_scroll_element_into_view_does_not_raise(self, driver: BSWebDriverSync):
        """scroll_element_into_view() no debe lanzar excepción."""
        driver.navigate_to(TEST_URL)
        driver.wait_element_to_be_present(LOC_LINK)
        driver.scroll_element_into_view(LOC_LINK)

    def test_execute_script_returns_no_error(self, driver: BSWebDriverSync):
...
class TestBSWebDriverScreenshot:
    ...
    def test_save_screenshot_creates_file(self, driver: BSWebDriverSync, tmp_path):
    ...
    def test_save_screenshot_after_navigation(self, driver: BSWebDriverSync, tmp_path):
    ...
    def test_save_element_screenshot_creates_file(self, driver: BSWebDriverSync, tmp_path):
